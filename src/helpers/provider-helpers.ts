...
const providerBnb = process.env.PROVIDER_BNB as string;
let provider_bnb = ethers.providers.getDefaultProvider(providerBnb);
...
setInterval(() => {
	...
	provider_bnb = ethers.providers.getDefaultProvider(providerArbitrum);
}, 2 * 1000 * 60);
